...
if [ $DEVICE_TYPE = "Normal" ]; then
    ...
    if [[ $BUILD_EXTR_PAR = *--enable_training* ]]; then
      ${PYTHON_EXE} -m pip install --upgrade --pre torch==1.6.0.dev20200623 torchvision==0.7.0.dev20200623 -f https://download.pytorch.org/whl/nightly/cu101/torch_nightly.html
