...
typedef enum OrtSessionConfigKey {
  ORT_SESSION_CONFIG_EP_NNAPI_ENABLE_NCHW,
  ORT_SESSION_CONFIG_EP_NNAPI_ENABLE_FP16,
  ORT_SESSION_CONFIG_EP_NNAPI_DEVICE_OPTION,
 ...
 */
  ...
  */
  ...
  // Set a single session configuration entry
  ORT_API2_STATUS(SetSessionConfiguration, _Inout_ OrtSessionOptions* options, _In_ OrtSessionConfigKey config_key, _In_ const char* config_value);
};
