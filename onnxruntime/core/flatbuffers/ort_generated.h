...
template <>
struct TypeInfoValueTraits<onnxruntime::experimental::fbs::TensorTypeAndShape> {
...
template <>
inline const onnxruntime::experimental::fbs::TensorTypeAndShape* TypeInfo::value_as<onnxruntime::experimental::fbs::TensorTypeAndShape>() const {
...
struct Model FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const onnxruntime::experimental::fbs::OperatorSetId* opset_import() const {
    return GetPointer<const onnxruntime::experimental::fbs::OperatorSetId*>(VT_OPSET_IMPORT);
  }
  ...
  bool Verify(flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyTable(opset_import()) &&
...
struct ModelBuilder {
  ...
  void add_opset_import(flatbuffers::Offset<onnxruntime::experimental::fbs::OperatorSetId> opset_import) {
...
inline flatbuffers::Offset<Model> CreateModel(
    ...
    flatbuffers::Offset<onnxruntime::experimental::fbs::OperatorSetId> opset_import = 0,
